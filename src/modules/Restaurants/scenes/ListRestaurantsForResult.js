...
const SORTS = {
    ...
    NAME_FIND:(list,word)=>
        ...
        return includes(item.postcode,word);
    })
   ...
   console.log("the values" +" "+ values);
        ...
        render(){
            ...
            if (this.props.loading) {
               ...
               this.restaurant = SORTS['NAME_FIND'](data,this.state.sortvalue).map((data) => (
         ...
         <div className="container food-list">
             ...
             <h1 className="food-heading" >Restaurants for that category</h1>
